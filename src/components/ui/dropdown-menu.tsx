...
function DropdownMenuTrigger({
  ...
  return (
    <MenuPrimitive.Trigger
      ...
      className={cn(
        'cursor-pointer className="focus:outline-none rounded-full ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
        className,
      )}
      {...props}
    />
